...
df = read.csv("FILEPATH/self_harm_asmr_2021_results.csv")
df$val <- df$val*100000
...
options(OutDec="\u0B7")
pdf(paste0(outdir, "Self_harm_ASMR.pdf"), height = 4.15, width = 7.5, pointsize = 6.5, fonts = f3)
gbd_map(data = listdf[[1]], 
        ...
        Figure 3: Age-standardised mortality rate per 100 000 population for firearm-related suicides, males and females combined, 2021",
