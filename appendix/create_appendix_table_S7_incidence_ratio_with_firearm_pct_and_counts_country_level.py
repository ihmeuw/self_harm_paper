...
def calc_ratio(sex_id, location_id):
    ...
    df = pd.merge(df_2021_deaths_draws, df_2021_incidence_draws).merge(df_2021_incidence_ratio).merge(df_2021_pct_firearm)
...
df = df[['location_name',
       ...
       'lower.ratio.Male', 'val.firearm_pct.Male', 'upper.firearm_pct.Male',
       ...
       'lower.ratio.Female', 'val.firearm_pct.Female', 'upper.firearm_pct.Female',
...
df.to_csv("/FILEPATH/appendix_table_3_with_all_ui_lvl_all.csv",index=False)