...
OUT_DIR = "/FILEPATH/"
df <- read.csv("/FILEPATH/appendix_table_2_average_age_1990_2021_country_level.csv")
...
as_lancet_table(df,
    ...
    title = title1,
    lancet_font = T, 
    outfile = paste0("/FILEPATH/appendix_table_2_formatted_average_age_1990_2021_country_level", ".xlsx"))
